...
enum PreviewLoader {
    ...
    ///   - sources: Paths to sources to validate that these previews belong to the desired project
    ...
    static func loadPreviewBody(from fileURL: URL, and sources: [String], defaultEnabled: Bool) -> String? {
        ...
        guard let macroSource = lines.last,
              sources.first(where: { macroSource.hasPrefix(Keys.source + $0) }) != nil else { return nil }
